...
export class ClienteService {
  ...
  update(cliente: ICliente): Observable<EntityResponseType> {
    return this.http.put<ICliente>(`${this.resourceUrl}/${getClienteIdentifier(cliente) as string}`, cliente, { observe: 'response' });
  }

  partialUpdate(cliente: ICliente): Observable<EntityResponseType> {
    return this.http.patch<ICliente>(`${this.resourceUrl}/${getClienteIdentifier(cliente) as string}`, cliente, { observe: 'response' });
  }
